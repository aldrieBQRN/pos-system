                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                        <button
                            ...
                            className={`flex flex-col items-center justify-center py-4 rounded-xl border-2 transition-all duration-200 gap-2
                                ${method === 'cash' ? 'border-green-500 bg-green-50 text-green-700 shadow-sm transform scale-[1.02]' : 'border-gray-100 bg-white text-gray-500 hover:border-gray-300'}`}
                        >
                        ...
                        <button
                            ...
                            className={`flex flex-col items-center justify-center py-4 rounded-xl border-2 transition-all duration-200 gap-2
                                ${method === 'gcash' ? 'border-blue-500 bg-blue-50 text-blue-700 shadow-sm transform scale-[1.02]' : 'border-gray-100 bg-white text-gray-500 hover:border-gray-300'}`}
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
